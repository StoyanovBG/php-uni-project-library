...
<head lang="en">  
    ...
    <title>Търсене/Заемане по заглавие</title>  
</head>  
<style>  
body{
        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="login-panel">  
                <div class="panel-heading">  
                    <h3 class="panel-title">Търсене/Заемане по заглавие</h3>  
                </div>  
                <div class="panel-body">  
                    <form role="form" method="post" action="#">  
                        <fieldset>  
                            <div class="form-group">  
                                <input class="form-control" placeholder="Title" name="search" type="text" autofocus required="">  
                            </div>   
...
<?php
    if (isset($_POST['submit'])) {
        ...
        //!ctype_alnum($searchString) ||  ne priema simvoli +=?.,';! ...
        ...
        <?php
         ...
         <tr>
            ...
            <?php 
                    if( $row['id_status'] == 1){ ?>
                      <td><a href="zaemaneTitle.php?zemi=<?php echo $row['id_book'] ?>"><button class="btn btn-success">Заеми</button></a></td>    
            <?php   }  ?>
        </tr>  

...
<head lang="en">  
    ...
    <title>Търсене/Заемане по жанр</title>  
</head>  
<style>  
body{
        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="login-panel">  
                <div class="panel-heading">  
                    <h3 class="panel-title">Търсене/Заемане по жанр</h3>  
                </div>  
                <div class="panel-body">  
                    <form role="form" method="post" action="#">  
                        <fieldset>  
                            <div class="form-group">  
                                <input class="form-control" placeholder="Genre" name="search" type="text" autofocus required="">  
                            </div>   
...
<?php
    if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT b.id_book , b.title , b.author , b.yearOfPublishing , b.publisher , g.id_genre , b.id_status , g.genre  FROM book b
        ...
        <?php
         ...
         <tr>
            ...
            <?php 
                    if( $row['id_status'] == 1){ ?>
                      <td><a href="zaemaneGenre.php?zemi=<?php echo $row['id_book'] ?>"><button class="btn btn-success">Заеми</button></a></td>    
            <?php   }  ?>
        </tr>  

        ...
        <div class="col-md-5 col-md-offset-3">
            <div class="login-panel">  
                <div class="panel-heading">  
                    <h3 class="panel-title">Редактиране на служител</h3>  
                </div>  
...
<form role='form' method="post" action='#'>
    <fieldset>  
        ...
        <br>
          <input class="btn btn-lg btn-success btn-block" type="submit" value="Редактирай" name="submit" style="background-color: palevioletred;" >  
    </form>
     <br>
    <table border="7">  
        <thead>  
      ...
      <center><b></b> <br></b><a href="./editEmployee.php">Назад</a> <br></b>  </center>
</body>
</html>
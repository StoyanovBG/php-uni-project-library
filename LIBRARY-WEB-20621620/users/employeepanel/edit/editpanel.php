            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                     <a href="./editBook/editBook.php" class="btn btn-secondary my-2">Редактирай</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card mb-4 box-shadow">
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                     <a href="./editPositions/editPositions.php" class="btn btn-secondary my-2">Редактирай</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card mb-4 box-shadow">
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                     <a href="./editGenre/editGenre.php" class="btn btn-secondary my-2">Редактирай</a>
                    </div>
                  </div>
                </div>
              </div>

            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                     <a href="./addBook.php" class="btn btn-secondary my-2">Добави</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card mb-4 box-shadow">
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                     <a href="./addPosition.php" class="btn btn-secondary my-2">Добави</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card mb-4 box-shadow">
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                     <a href="./addGenre.php" class="btn btn-secondary my-2">Добави</a>
                    </div>
                  </div>
                </div>
              </div>
